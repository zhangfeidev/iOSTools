...
#define contentOffSet_x self.direct.contentOffset.x  //获取ScrollView的X值偏移量

#define frame_width     self.direct.frame.size.width //获取ScrollView的宽度

#define contentSize_x   self.direct.contentSize.width//获取ScrollView的contentSize宽度
...
{
    return [[CarouselView alloc]initWithtFrame:frame ImageArr:imageNameArray AndImageClickBlock:clickBlock];
}
...
{
    return [[CarouselView alloc]initWithtFrame:frame ViewArr:customViewArr AndImageClickBlock:clickBlock];
}
